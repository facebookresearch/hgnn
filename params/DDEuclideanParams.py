...
def add_params(parser):
    ...
    parser.add_argument('--embed_size', type=int, default=89)  
    parser.add_argument('--grad_clip', type=float, default=5.)
    parser.add_argument('--dropout', type=float, default=0.0)
    parser.add_argument('--activation', type=str, default='rrelu', choices=['leaky_relu', 'rrelu'])
    ...
    parser.add_argument('--train_file', type=str, default='data/tu/DD_train_%d.json')
    parser.add_argument('--dev_file', type=str, default='data/tu/DD_valid_%d.json')
    parser.add_argument('--test_file', type=str, default='data/tu/DD_test_%d.json')
    parser.add_argument('--num_feature', type=int, default=89)
    ...
    parser.add_argument('--remove_embed', type=str2bool, default=True) 
