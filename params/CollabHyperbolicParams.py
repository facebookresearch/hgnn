...
def add_params(parser):     
    ...
    parser.add_argument("--num_centroid", type=int, default=3)
    parser.add_argument('--max_epochs', type=int, default=200)
    parser.add_argument('--gnn_layer', type=int, default=3) 
    parser.add_argument('--grad_clip', type=float, default=5.)
    parser.add_argument('--dropout', type=float, default=0.3)
    parser.add_argument('--activation', type=str, default='relu', choices=['relu', 'leaky_relu', 'rrelu', 'selu', 'elu'])
    ...
    parser.add_argument('--train_file', type=str, default='data/tu/COLLAB_train_%d.json')
    parser.add_argument('--dev_file', type=str, default='data/tu/COLLAB_valid_%d.json')
    parser.add_argument('--test_file', type=str, default='data/tu/COLLAB_test_%d.json')
    parser.add_argument('--num_class', type=int, default=3)
    parser.add_argument('--num_feature', type=int, default=8100)
