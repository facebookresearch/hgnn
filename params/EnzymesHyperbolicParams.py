...
def add_params(parser):     
    ...
    parser.add_argument('--lr_hyperbolic', type=float, default=0.0001)
    ...
    parser.add_argument("--num_centroid", type=int, default=600)
    parser.add_argument('--max_epochs', type=int, default=800)
    parser.add_argument('--gnn_layer', type=int, default=6) 
    ...
    parser.add_argument('--train_file', type=str, default='data/tu/ENZYMES_train_%d.json')
    parser.add_argument('--dev_file', type=str, default='data/tu/ENZYMES_valid_%d.json')
    parser.add_argument('--test_file', type=str, default='data/tu/ENZYMES_test_%d.json')
